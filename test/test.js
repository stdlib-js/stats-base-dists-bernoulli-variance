...
tape( 'if provided `1` or `0` for `p`, the function returns `0`', function test( t ) {
	var v = variance( 1.0 );
...
tape( 'the function returns the variance of a Bernoulli distribution', function test( t ) {
	var expected;
	var delta;
	var tol;
	var i;
